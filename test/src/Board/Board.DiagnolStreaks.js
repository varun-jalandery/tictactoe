...
describe('src/Board/Board - Check Diagonal Streaks : isWinningStreakOccurringAroundCell()', () => {
    ...
    it('should return true if diagonal one top streak is formed', done => {
        ...
        board.markCell(70, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(70, 'x'),
            true,
    ...
    it('should return true if diagonal one center Streak is formed', done => {
        ...
        board.markCell(76, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(76, 'x'),
            true,
    ...
    it('should return true if diagonal one bottom streak is formed', done => {
        ...
        board.markCell(66, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(66, 'x'),
            true,
    ...
    it('should return true if diagonal two top streak is formed', done => {
        ...
        board.markCell(68, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(68, 'x'),
            true,
    ...
    it('should return true if diagonal two center Streak is formed', done => {
        ...
        board.markCell(56, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(56, 'x'),
            true,
    ...
    it('should return true if diagonal two bottom streak is formed', done => {
        ...
        board.markCell(75, 'x');
        assert.equal(
            board.isWinningStreakOccurringAroundCell(75, 'x'),
            true,
